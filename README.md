...
A sleek, responsive, and modern personal portfolio website showcasing my journey, technical skills, projects, and educational background as a Full-Stack Developer.
...
- **Tools & Platforms:** Git, GitHub, VS Code, Postman, IoT Basics
...
1. **Clone the repository:**
   ```bash
   git clone https://github.com/atul-techx/HTML-CSS-Portfolio.git
   ```
